...
module Computer_System_mm_interconnect_1 (
	...
	wire  [101:0] vga_subsystem_pixel_dma_master_agent_cp_data;                                                        // VGA_Subsystem_pixel_dma_master_agent:cp_data -> router_002:sink_data
	...
	wire  [128:0] onchip_sram_s1_agent_rp_data;                                                                        // Onchip_SRAM_s1_agent:rp_data -> router_005:sink_data
	...
	wire          onchip_sram_s2_agent_rp_valid;                                                                       // Onchip_SRAM_s2_agent:rp_valid -> router_006:sink_valid
	wire  [128:0] onchip_sram_s2_agent_rp_data;                                                                        // Onchip_SRAM_s2_agent:rp_data -> router_006:sink_data
	wire          onchip_sram_s2_agent_rp_ready;                                                                       // router_006:sink_ready -> Onchip_SRAM_s2_agent:rp_ready
	wire          onchip_sram_s2_agent_rp_startofpacket;                                                               // Onchip_SRAM_s2_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire          onchip_sram_s2_agent_rp_endofpacket;                                                                 // Onchip_SRAM_s2_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire  [101:0] router_002_src_data;                                                                                 // router_002:src_data -> VGA_Subsystem_pixel_dma_master_limiter:cmd_sink_data
	wire          router_002_src_ready;                                                                                // VGA_Subsystem_pixel_dma_master_limiter:cmd_sink_ready -> router_002:src_ready
	wire    [3:0] router_002_src_channel;                                                                              // router_002:src_channel -> VGA_Subsystem_pixel_dma_master_limiter:cmd_sink_channel
	...
	wire  [101:0] vga_subsystem_pixel_dma_master_limiter_cmd_src_data;                                                 // VGA_Subsystem_pixel_dma_master_limiter:cmd_src_data -> cmd_demux_002:sink_data
	...
	wire    [3:0] vga_subsystem_pixel_dma_master_limiter_cmd_src_channel;                                              // VGA_Subsystem_pixel_dma_master_limiter:cmd_src_channel -> cmd_demux_002:sink_channel
	...
	wire  [101:0] rsp_mux_002_src_data;                                                                                // rsp_mux_002:src_data -> VGA_Subsystem_pixel_dma_master_limiter:rsp_sink_data
	wire          rsp_mux_002_src_ready;                                                                               // VGA_Subsystem_pixel_dma_master_limiter:rsp_sink_ready -> rsp_mux_002:src_ready
	wire    [3:0] rsp_mux_002_src_channel;                                                                             // rsp_mux_002:src_channel -> VGA_Subsystem_pixel_dma_master_limiter:rsp_sink_channel
	...
	wire          cmd_demux_002_src0_valid;                                                                            // cmd_demux_002:src0_valid -> VGA_Subsystem_pixel_dma_master_to_SDRAM_s1_cmd_width_adapter:in_valid
	wire  [101:0] cmd_demux_002_src0_data;                                                                             // cmd_demux_002:src0_data -> VGA_Subsystem_pixel_dma_master_to_SDRAM_s1_cmd_width_adapter:in_data
	wire          cmd_demux_002_src0_ready;                                                                            // VGA_Subsystem_pixel_dma_master_to_SDRAM_s1_cmd_width_adapter:in_ready -> cmd_demux_002:src0_ready
	wire    [3:0] cmd_demux_002_src0_channel;                                                                          // cmd_demux_002:src0_channel -> VGA_Subsystem_pixel_dma_master_to_SDRAM_s1_cmd_width_adapter:in_channel
	wire          cmd_demux_002_src0_startofpacket;                                                                    // cmd_demux_002:src0_startofpacket -> VGA_Subsystem_pixel_dma_master_to_SDRAM_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_demux_002_src0_endofpacket;                                                                      // cmd_demux_002:src0_endofpacket -> VGA_Subsystem_pixel_dma_master_to_SDRAM_s1_cmd_width_adapter:in_endofpacket
	wire          vga_subsystem_pixel_dma_master_to_sdram_s1_cmd_width_adapter_src_valid;                              // VGA_Subsystem_pixel_dma_master_to_SDRAM_s1_cmd_width_adapter:out_valid -> cmd_mux_001:sink2_valid
	wire  [110:0] vga_subsystem_pixel_dma_master_to_sdram_s1_cmd_width_adapter_src_data;                               // VGA_Subsystem_pixel_dma_master_to_SDRAM_s1_cmd_width_adapter:out_data -> cmd_mux_001:sink2_data
	wire          vga_subsystem_pixel_dma_master_to_sdram_s1_cmd_width_adapter_src_ready;                              // cmd_mux_001:sink2_ready -> VGA_Subsystem_pixel_dma_master_to_SDRAM_s1_cmd_width_adapter:out_ready
	wire    [3:0] vga_subsystem_pixel_dma_master_to_sdram_s1_cmd_width_adapter_src_channel;                            // VGA_Subsystem_pixel_dma_master_to_SDRAM_s1_cmd_width_adapter:out_channel -> cmd_mux_001:sink2_channel
	wire          vga_subsystem_pixel_dma_master_to_sdram_s1_cmd_width_adapter_src_startofpacket;                      // VGA_Subsystem_pixel_dma_master_to_SDRAM_s1_cmd_width_adapter:out_startofpacket -> cmd_mux_001:sink2_startofpacket
	wire          vga_subsystem_pixel_dma_master_to_sdram_s1_cmd_width_adapter_src_endofpacket;                        // VGA_Subsystem_pixel_dma_master_to_SDRAM_s1_cmd_width_adapter:out_endofpacket -> cmd_mux_001:sink2_endofpacket
	wire          cmd_demux_002_src1_valid;                                                                            // cmd_demux_002:src1_valid -> VGA_Subsystem_pixel_dma_master_to_Onchip_SRAM_s2_cmd_width_adapter:in_valid
	wire  [101:0] cmd_demux_002_src1_data;                                                                             // cmd_demux_002:src1_data -> VGA_Subsystem_pixel_dma_master_to_Onchip_SRAM_s2_cmd_width_adapter:in_data
	wire          cmd_demux_002_src1_ready;                                                                            // VGA_Subsystem_pixel_dma_master_to_Onchip_SRAM_s2_cmd_width_adapter:in_ready -> cmd_demux_002:src1_ready
	wire    [3:0] cmd_demux_002_src1_channel;                                                                          // cmd_demux_002:src1_channel -> VGA_Subsystem_pixel_dma_master_to_Onchip_SRAM_s2_cmd_width_adapter:in_channel
	wire          cmd_demux_002_src1_startofpacket;                                                                    // cmd_demux_002:src1_startofpacket -> VGA_Subsystem_pixel_dma_master_to_Onchip_SRAM_s2_cmd_width_adapter:in_startofpacket
	wire          cmd_demux_002_src1_endofpacket;                                                                      // cmd_demux_002:src1_endofpacket -> VGA_Subsystem_pixel_dma_master_to_Onchip_SRAM_s2_cmd_width_adapter:in_endofpacket
	...
	wire          rsp_demux_001_src2_valid;                                                                            // rsp_demux_001:src2_valid -> SDRAM_s1_to_VGA_Subsystem_pixel_dma_master_rsp_width_adapter:in_valid
	wire  [110:0] rsp_demux_001_src2_data;                                                                             // rsp_demux_001:src2_data -> SDRAM_s1_to_VGA_Subsystem_pixel_dma_master_rsp_width_adapter:in_data
	wire          rsp_demux_001_src2_ready;                                                                            // SDRAM_s1_to_VGA_Subsystem_pixel_dma_master_rsp_width_adapter:in_ready -> rsp_demux_001:src2_ready
	wire    [3:0] rsp_demux_001_src2_channel;                                                                          // rsp_demux_001:src2_channel -> SDRAM_s1_to_VGA_Subsystem_pixel_dma_master_rsp_width_adapter:in_channel
	wire          rsp_demux_001_src2_startofpacket;                                                                    // rsp_demux_001:src2_startofpacket -> SDRAM_s1_to_VGA_Subsystem_pixel_dma_master_rsp_width_adapter:in_startofpacket
	wire          rsp_demux_001_src2_endofpacket;                                                                      // rsp_demux_001:src2_endofpacket -> SDRAM_s1_to_VGA_Subsystem_pixel_dma_master_rsp_width_adapter:in_endofpacket
	wire          sdram_s1_to_vga_subsystem_pixel_dma_master_rsp_width_adapter_src_valid;                              // SDRAM_s1_to_VGA_Subsystem_pixel_dma_master_rsp_width_adapter:out_valid -> rsp_mux_002:sink0_valid
	wire  [101:0] sdram_s1_to_vga_subsystem_pixel_dma_master_rsp_width_adapter_src_data;                               // SDRAM_s1_to_VGA_Subsystem_pixel_dma_master_rsp_width_adapter:out_data -> rsp_mux_002:sink0_data
	wire          sdram_s1_to_vga_subsystem_pixel_dma_master_rsp_width_adapter_src_ready;                              // rsp_mux_002:sink0_ready -> SDRAM_s1_to_VGA_Subsystem_pixel_dma_master_rsp_width_adapter:out_ready
	wire    [3:0] sdram_s1_to_vga_subsystem_pixel_dma_master_rsp_width_adapter_src_channel;                            // SDRAM_s1_to_VGA_Subsystem_pixel_dma_master_rsp_width_adapter:out_channel -> rsp_mux_002:sink0_channel
	...
	wire          onchip_sram_s2_to_vga_subsystem_pixel_dma_master_rsp_width_adapter_src_valid;                        // Onchip_SRAM_s2_to_VGA_Subsystem_pixel_dma_master_rsp_width_adapter:out_valid -> rsp_mux_002:sink1_valid
	wire  [101:0] onchip_sram_s2_to_vga_subsystem_pixel_dma_master_rsp_width_adapter_src_data;                         // Onchip_SRAM_s2_to_VGA_Subsystem_pixel_dma_master_rsp_width_adapter:out_data -> rsp_mux_002:sink1_data
	wire          onchip_sram_s2_to_vga_subsystem_pixel_dma_master_rsp_width_adapter_src_ready;                        // rsp_mux_002:sink1_ready -> Onchip_SRAM_s2_to_VGA_Subsystem_pixel_dma_master_rsp_width_adapter:out_ready
	wire    [3:0] onchip_sram_s2_to_vga_subsystem_pixel_dma_master_rsp_width_adapter_src_channel;                      // Onchip_SRAM_s2_to_VGA_Subsystem_pixel_dma_master_rsp_width_adapter:out_channel -> rsp_mux_002:sink1_channel
	wire          onchip_sram_s2_to_vga_subsystem_pixel_dma_master_rsp_width_adapter_src_startofpacket;                // Onchip_SRAM_s2_to_VGA_Subsystem_pixel_dma_master_rsp_width_adapter:out_startofpacket -> rsp_mux_002:sink1_startofpacket
	wire          onchip_sram_s2_to_vga_subsystem_pixel_dma_master_rsp_width_adapter_src_endofpacket;                  // Onchip_SRAM_s2_to_VGA_Subsystem_pixel_dma_master_rsp_width_adapter:out_endofpacket -> rsp_mux_002:sink1_endofpacket
	...
	wire    [3:0] vga_subsystem_pixel_dma_master_limiter_cmd_valid_data;                                               // VGA_Subsystem_pixel_dma_master_limiter:cmd_src_valid -> cmd_demux_002:sink_valid
	...
	Computer_System_mm_interconnect_1_cmd_mux_001 cmd_mux_001 (
		...
		.sink2_ready         (vga_subsystem_pixel_dma_master_to_sdram_s1_cmd_width_adapter_src_ready),         //     sink2.ready
		.sink2_valid         (vga_subsystem_pixel_dma_master_to_sdram_s1_cmd_width_adapter_src_valid),         //          .valid
		.sink2_channel       (vga_subsystem_pixel_dma_master_to_sdram_s1_cmd_width_adapter_src_channel),       //          .channel
		.sink2_data          (vga_subsystem_pixel_dma_master_to_sdram_s1_cmd_width_adapter_src_data),          //          .data
		.sink2_startofpacket (vga_subsystem_pixel_dma_master_to_sdram_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink2_endofpacket   (vga_subsystem_pixel_dma_master_to_sdram_s1_cmd_width_adapter_src_endofpacket)    //          .endofpacket
	);
