...
module Computer_System_mm_interconnect_2 (
	...
	wire  [117:0] slider_switches_s1_agent_rp_data;                                            // Slider_Switches_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [117:0] pushbuttons_s1_agent_rp_data;                                                // Pushbuttons_s1_agent:rp_data -> router_009:sink_data
	...
	wire    [8:0] cmd_mux_002_src_channel;                                                     // cmd_mux_002:src_channel -> VGA_Subsystem_char_buffer_control_slave_burst_adapter:sink0_channel
	...
	wire    [8:0] cmd_mux_003_src_channel;                                                     // cmd_mux_003:src_channel -> SysID_control_slave_burst_adapter:sink0_channel
	...
	wire          cmd_mux_006_src_valid;                                                       // cmd_mux_006:src_valid -> Slider_Switches_s1_burst_adapter:sink0_valid
	wire  [117:0] cmd_mux_006_src_data;                                                        // cmd_mux_006:src_data -> Slider_Switches_s1_burst_adapter:sink0_data
	wire          cmd_mux_006_src_ready;                                                       // Slider_Switches_s1_burst_adapter:sink0_ready -> cmd_mux_006:src_ready
	wire    [8:0] cmd_mux_006_src_channel;                                                     // cmd_mux_006:src_channel -> Slider_Switches_s1_burst_adapter:sink0_channel
	wire          cmd_mux_006_src_startofpacket;                                               // cmd_mux_006:src_startofpacket -> Slider_Switches_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                 // cmd_mux_006:src_endofpacket -> Slider_Switches_s1_burst_adapter:sink0_endofpacket
	...
	wire  [117:0] cmd_mux_007_src_data;                                                        // cmd_mux_007:src_data -> Pushbuttons_s1_burst_adapter:sink0_data
	wire          cmd_mux_007_src_ready;                                                       // Pushbuttons_s1_burst_adapter:sink0_ready -> cmd_mux_007:src_ready
	wire    [8:0] cmd_mux_007_src_channel;                                                     // cmd_mux_007:src_channel -> Pushbuttons_s1_burst_adapter:sink0_channel
	...
	wire    [8:0] cmd_mux_008_src_channel;                                                     // cmd_mux_008:src_channel -> Pixel_DMA_Addr_Translation_slave_burst_adapter:sink0_channel
	...
	wire          slider_switches_s1_agent_rdata_fifo_out_valid;                               // Slider_Switches_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] slider_switches_s1_agent_rdata_fifo_out_data;                                // Slider_Switches_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_006:in_0_data
	wire          slider_switches_s1_agent_rdata_fifo_out_ready;                               // avalon_st_adapter_006:in_0_ready -> Slider_Switches_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_006_out_0_valid;                                           // avalon_st_adapter_006:out_0_valid -> Slider_Switches_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                            // avalon_st_adapter_006:out_0_data -> Slider_Switches_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                           // Slider_Switches_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                           // avalon_st_adapter_006:out_0_error -> Slider_Switches_s1_agent:rdata_fifo_sink_error
