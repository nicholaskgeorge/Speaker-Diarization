...
module Computer_System_mm_interconnect_0 (
	...
	wire  [111:0] rsp_mux_002_src_data;                                                              // rsp_mux_002:src_data -> Bus_master_audio_avalon_master_agent:rp_data
	wire          rsp_mux_002_src_ready;                                                             // Bus_master_audio_avalon_master_agent:rp_ready -> rsp_mux_002:src_ready
	wire    [2:0] rsp_mux_002_src_channel;                                                           // rsp_mux_002:src_channel -> Bus_master_audio_avalon_master_agent:rp_channel
	...
	wire  [111:0] bus_master_audio_avalon_master_agent_cp_data;                                      // Bus_master_audio_avalon_master_agent:cp_data -> router_002:sink_data
	...
	wire  [111:0] cmd_mux_src_data;                                                                  // cmd_mux:src_data -> Audio_Subsystem_audio_slave_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                                                 // Audio_Subsystem_audio_slave_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [2:0] cmd_mux_src_channel;                                                               // cmd_mux:src_channel -> Audio_Subsystem_audio_slave_burst_adapter:sink0_channel
	...
	wire  [111:0] audio_subsystem_audio_slave_burst_adapter_source0_data;                            // Audio_Subsystem_audio_slave_burst_adapter:source0_data -> Audio_Subsystem_audio_slave_agent:cp_data
	...
	wire    [2:0] audio_subsystem_audio_slave_burst_adapter_source0_channel;                         // Audio_Subsystem_audio_slave_burst_adapter:source0_channel -> Audio_Subsystem_audio_slave_agent:cp_channel
	...
	wire  [111:0] cmd_mux_001_src_data;                                                              // cmd_mux_001:src_data -> AV_Config_avalon_av_config_slave_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                                             // AV_Config_avalon_av_config_slave_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [2:0] cmd_mux_001_src_channel;                                                           // cmd_mux_001:src_channel -> AV_Config_avalon_av_config_slave_burst_adapter:sink0_channel
